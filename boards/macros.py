...
class CommonMacros:
    ...
    def __init__(self, KC):
        ...
        self.COLON = KC.TD(KC.COLON, KC.SCLN)
        ...
        self.SRHTWN = KC.LGUI(KC.LSHIFT(KC.RGHT))
        self.SLFTWN = KC.LGUI(KC.LSHIFT(KC.LEFT))
        self.CTLSC = KC.LCTL(KC.LSHIFT(KC.C))
        self.CTLSV = KC.LCTL(KC.LSHIFT(KC.V))
        self.SFTINS = KC.LSHIFT(KC.INS)
