...
class LabviewMacros:
    def __init__(self, KC) -> None:
        ...
        self.qdrs = simple_key_sequence((start_seq, CTLSFT(KC.R)))
        ...
        self.qdds = simple_key_sequence((start_seq, CTLSFT(KC.D)))
        self.qdt = simple_key_sequence((start_seq, KC.LCTL(KC.T)))
        ...
        #         )
        #     )
        self.qdv = simple_key_sequence((start_seq, KC.LCTL(KC.V)))
        ...
        #         )
        #     )
        self.qdp = simple_key_sequence((start_seq, KC.LCTL(KC.P)))
        self.qdps = simple_key_sequence((start_seq, CTLSFT(KC.P)))
        ...
        #         )
        #     )
        self.qdw = simple_key_sequence((start_seq, KC.LCTL(KC.W)))
        ...
        #         )
        #     )
        self.qdx = simple_key_sequence((start_seq, KC.LCTL(KC.X)))
        ...
        #         )
        #     )
        self.qdq = simple_key_sequence((start_seq, KC.LCTL(KC.Q)))
        ...
        #         )
        #     )
        self.qda = simple_key_sequence((start_seq, KC.LCTL(KC.A)))
        self.qdas = simple_key_sequence((start_seq, CTLSFT(KC.A)))
        self.qdz = simple_key_sequence((start_seq, KC.LCTL(KC.Z)))
        ...
        #         )
        #     )
        self.qd1 = simple_key_sequence((start_seq, KC.LCTL(KC.N1)))
        self.qd1s = simple_key_sequence((start_seq, CTLSFT(KC.N1)))
        self.qd2 = simple_key_sequence((start_seq, KC.LCTL(KC.N2)))
        ...
        #         )
        #     )
        self.qd3 = simple_key_sequence((start_seq, KC.LCTL(KC.N3)))
        ...
        #         )
        #     )
        self.qd8 = simple_key_sequence((start_seq, KC.LCTL(KC.N8)))
        ...
        #         )
        #     )
        self.qd9 = simple_key_sequence((start_seq, KC.LCTL(KC.N9)))
        ...
        #         )
        #     )
        self.qd0 = simple_key_sequence((start_seq, KC.LCTL(KC.N0)))
        ...
        #         )
        #     )
        self.qdj = simple_key_sequence((start_seq, KC.LCTL(KC.J)))
        ...
        #         )
        #     )
        self.qdm = simple_key_sequence((start_seq, KC.LCTL(KC.M)))
        ...
        self.qdkleave = simple_key_sequence((KC.LCTL(KC.K), KC.TG(5)))
        ...
        #         )
        #     )
        self.qdu = simple_key_sequence((start_seq, KC.LCTL(KC.U)))
        ...
        #         )
        #     )
        self.qdi = simple_key_sequence((start_seq, KC.LCTL(KC.I)))
        ...
        self.qdtxt = simple_key_sequence((self.QD, KC.TG(5)))
        # git quick drop & goto macro layer
        self.qdgit = simple_key_sequence((KC.LCTL(KC.N7), KC.TG(5)))
